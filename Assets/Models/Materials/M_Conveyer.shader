    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float2 node_4172 = float2((i.uv0.r*_Direction_X),(i.uv0.g*_Direction_Y));
                float2 node_1659 = (node_4172+(node_2842.g*_Speed)*float2(-0.3,0));
                float3 _BumpMap_var = UnpackNormal(tex2D(_BumpMap,TRANSFORM_TEX(node_1659, _BumpMap)));
...
/////// Diffuse:
                ...
                float3 diffuseColor = lerp( _Color.rgb, (_Diffuse_var.rgb*_Color.rgb), _Diff_Texture );
